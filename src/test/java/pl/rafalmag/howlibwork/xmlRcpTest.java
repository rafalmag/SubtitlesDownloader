...
public class xmlRcpTest {
	...
	public void should_get_xmlRcp() throws Exception {
		...
		Map<String,Object> execute = (Map<String, Object>) client.execute("ServerInfo",params);
	    assertThat(execute,Matchers.hasEntry("website_url", (Object)"http://www.opensubtitles.org"));
	}
